...
const Paris5Page: React.FC<Paris5PageProps> = ({ onBack, onNavigateHome, onQuoteRequest, onPhotoboothDetails, onAIAnimations, onSEOPage, onParis1Page, onParis2Page, onParis3Page, onParis4Page, onParis6Page, onParis7Page, onParis8Page, onParis9Page }) => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Footer
        ...
        arrondissementLinks={getArrondissementLinks('paris5', {
          onParis1Page,
          onParis2Page,
          onParis3Page,
          onParis4Page,
