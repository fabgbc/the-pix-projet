...
const Paris6Page: React.FC<Paris6PageProps> = ({ onBack, onNavigateHome, onQuoteRequest, onPhotoboothDetails, onAIAnimations, onSEOPage, onParis1Page, onParis2Page, onParis3Page, onParis4Page, onParis5Page, onParis7Page, onParis8Page, onParis9Page }) => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Footer
        ...
        arrondissementLinks={getArrondissementLinks('paris6', {
          onParis1Page,
          onParis2Page,
          onParis3Page,
          onParis4Page,
